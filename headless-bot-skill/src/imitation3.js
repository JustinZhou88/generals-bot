 ...
 * 模仿学习排序器策略 v2(线上推理端)。
 *
 * 【v3】模型加载:优先 replays/imitation/model3.json(MLP,32 维,含"不动"
...
// v3 优先用 MLP(model3.json);缺失时退回 v2 线性模型,行为与 imitation.js 一致。
const MODEL = fs.existsSync(MODEL3_PATH) ? require(MODEL3_PATH) : require(MODEL2_PATH);
